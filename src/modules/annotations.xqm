...
module namespace annotation = "http://www.oeaw.ac.at/acdh/cfdb/annotations";
...
declare namespace cfdb = "http://www.oeaw.ac.at/acdh/cfdb";
...
declare function annotation:read($tablet as element(tei:TEI), $surface-id as xs:string, $annotation-id as xs:string, $filter as xs:string*) {
    ...
    let $data := 
        <annotation>
            ...
            <img>/exist/apps/cfdb/$app-root/data/tablets/{$tablet-id||"/"||$glyph-img}</img>
