...
(:~
 ...
 : within a module.
 :)
module namespace config="http://www.oeaw.ac.at/acdh/cfdb/config";
...
declare variable $config:domain := "cfdb.acdh.oeaw.ac.at";

declare variable $config:data-root := "/db/cfdb-data";
